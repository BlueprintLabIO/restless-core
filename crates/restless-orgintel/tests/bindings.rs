...
use restless_orgintel::{
    ...
    IdentityStatementKind, IdentityWorkBindingRow, MessageRow, ObservedSkill, OutcomeStandard,
    OutcomeStandardSource, OwnerBrief, OwnerBriefKind, OwnerHandoffCategory, OwnerHandoffRow,
    OwnerHandoffState, ProducingTopology, ScheduleRow, SelectedSkill, SkillAssignmentRow, SkillRow,
    TeamRow, VisualChannel, VisualDirectionBrief, VisualEvidenceDetailRow, VisualEvidenceKind,
    VisualMotionState, VisualPrimitiveUseRow, VisualRenderEvidenceRow, VisualRepresentation,
    VisualReviewRow, VisualReviewVerdict, VisualWorkContractRow, VoiceChannel, VoiceContractBrief,
...
fn render() -> String {
    ...
    for decl in [
        ...
        SelectedSkill::decl(&cfg),
        ObservedSkill::decl(&cfg),
        MessageRow::decl(&cfg),
        EventRow::decl(&cfg),
