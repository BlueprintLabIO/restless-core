...
const messages=[];
const serviceRequire=createRequire(process.env.RESTLESS_TEST_REPO+'/services/native-documents-collaboration/package.json');
const {HocuspocusProvider,HocuspocusProviderWebsocket}=serviceRequire('@hocuspocus/provider');
const Y=serviceRequire('yjs');
const clients=[];
