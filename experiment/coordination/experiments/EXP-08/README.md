...
**Status:** awaiting Sprint 20 terminal evidence; the EXP-07 source gate and isolated
verification-output preflight have passed. No experiment arm, candidate playbook, frozen contract,
...
| --- | --- | --- | --- |
| EXP-07 successful Restless greenfield web outcome | A successful greenfield outcome plus usable Restless-specific source evidence | The founder locked a [tie with slight qualitative preference for the Restless design](../EXP-07/results/owner-decision.md). Candidate A is now unsealed as the Restless arm at `4e454bc2a36eab3afbf7d91a070e732cf657a847`; Candidate B is the Codex arm at `8b927ec4247e4dfc1301779009bd2b46a3742bf7`; both passed the common objective matrix | Satisfied as scoped source evidence; it is not a causal arm win or visual template |
...
1. Complete Sprint 20 to a truthful terminal classification with its required evidence package.
2. Preserve P1's failure and P2's passing fixed-output callback/ReviewTarget preflight rather than
   replacing either run.
3. Recheck the Sprint 20 source locator above, then freeze the smallest candidate playbook and its dated,
